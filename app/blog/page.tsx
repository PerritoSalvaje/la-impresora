...
const posts = [
  ...
  },
  {
    ...
    numero: "019",
    titulo: "Por qué necesitás una VPN para crypto: guía completa 2026",
    desc: "Por qué los exchanges bloquean IPs en ciertos países, cómo funciona una VPN, comparativa de NordVPN vs ProtonVPN vs ExpressVPN y cómo configurarla correctamente.",
    tag: "Crypto",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-dorado",
    categoria: "Crypto",
  },
  {
    ...
    numero: "020",
    titulo: "Impuestos sobre crypto por país: Argentina, México, Colombia y España 2026",
    desc: "Tabla comparativa de cómo tributa crypto en los 4 países principales hispanohablantes. Cuándo declarar, qué declarar y herramientas que ayudan.",
    tag: "Crypto",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-dorado",
    categoria: "Crypto",
  ...
  {
    slug: "que-es-y-como-funciona-defi",
    numero: "021",
    titulo: "Qué es DeFi: guía completa para principiantes en español 2026",
    desc: "DeFi explicado sin jerga: el banco eliminado, cómo funcionan Aave y Uniswap, yield farming, los riesgos reales, cómo empezar con $50 y las 5 reglas de oro.",
    tag: "Crypto",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-dorado",
    categoria: "Crypto",
  },
  {
    ...
    numero: "022",
    titulo: "Bitcoin como reserva de valor: ¿puede reemplazar al oro en 2026?",
    desc: "Historia del oro, qué hace similar a Bitcoin (escasez, portabilidad, divisibilidad), el caso de Michael Saylor, El Salvador y cómo posicionarte como inversor.",
    tag: "Crypto",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-dorado",
    categoria: "Crypto",
  },
  {
    ...
    numero: "023",
    titulo: "Los mayores fraudes crypto de la historia: FTX, Luna, OneCoin y más",
    desc: "Historia de los 5 grandes fraudes crypto: OneCoin ($4B), Bitconnect ($3.4B), Luna/TerraUST ($40B), FTX ($8B) y Squid Game Token. Señales de alerta y cómo protegerte.",
    tag: "Crypto",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-dorado",
    categoria: "Crypto",
  ...
  {
    slug: "psicologia-del-dinero-sesgos-cognitivos",
    numero: "024",
    titulo: "Psicología del dinero: los sesgos que te hacen perder en crypto y finanzas",
    desc: "FOMO, FUD, sesgo de confirmación, mentalidad de manada y aversión a la pérdida explicados con ejemplos reales de crypto. Sistemas para combatirlos.",
    tag: "Libertad Financiera",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-neutral",
    categoria: "Libertad Financiera",
  },
  {
    ...
    numero: "025",
    titulo: "Cómo ser nómada digital desde LATAM: la guía completa 2026",
    desc: "Trabajos remotos, visas para nómadas (Portugal D8, Georgia, México), manejo de ingresos con Wise y USDC, impuestos, seguros de salud y los mejores destinos.",
    tag: "Libertad Financiera",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-neutral",
    categoria: "Libertad Financiera",
  },
  {
    ...
    numero: "026",
    titulo: "Geopolítica y crypto: cómo las guerras y sanciones mueven el mercado",
    desc: "Rusia y sanciones, Bitcoin en El Salvador, el petrodólar, los BRICS y la desdolarización. Por qué la geopolítica es uno de los mejores indicadores adelantados de Bitcoin.",
    tag: "Crypto",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-dorado",
    categoria: "Crypto",
  },
  {
    ...
    numero: "027",
    titulo: "Privacidad digital y crypto: cómo proteger tu identidad y tu dinero en 2026",
    desc: "Rastreo blockchain, VPNs para exchanges, Monero y Zcash, seguridad operacional, CBDCs y el riesgo del dinero programable. La guía completa de privacidad para holders.",
    tag: "Crypto",
    fecha: "30 Abril 2026",
    tagClass: "badge badge-dorado",
    categoria: "Crypto",
