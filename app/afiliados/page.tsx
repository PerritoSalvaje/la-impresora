const afiliados = [
  ...
  {
    categoria: "Análisis & Herramientas",
    emoji: "📊",
    color: "text-verde",
    ...
    items: [
      {
        ...
        tipo: "Recurrente PERMANENTE — el mejor del mercado",
        latam: true,
        destaca: true,
      ...
      },
      {
        ...
        tipo: "Voces AI — esencial para canales faceless",
        latam: true,
        destaca: false,
        badge: null,
        badgeColor: "",
      },
      {
        ...
        tipo: "Videos con AI — muy usado por creadores LATAM",
        latam: true,
        destaca: false,
        badge: null,
        badgeColor: "",
      },
      {
        ...
        tipo: "Thumbnails, diseño — todos lo usan",
        latam: true,
        destaca: false,
        badge: null,
        badgeColor: "",
    ...
    items: [
      {
        ...
        tipo: "VPN — esencial para acceder a exchanges en LATAM",
        latam: true,
        destaca: true,
      ...
      {
        nombre: "Proton VPN",
        comision: "100% del primer mes",
        tipo: "La comisión más agresiva del mercado",
        latam: true,
        destaca: false,
        badge: null,
        badgeColor: "",
      },
      {
        ...
        tipo: "Alternativa popular — alta conversión",
        latam: true,
        destaca: false,
        badge: null,
        badgeColor: "",
